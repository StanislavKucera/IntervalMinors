...
\begin{thm}
\label{theorem1}
Let $P=\smm{1&1\\1&0}$, then for all $M\in\Mat$: $\PnimM\Leftrightarrow$ there exist a row~$r$ and a column~$c$, such that $M[[r-1],[c-1]],M[[r-1],[c+1,n]]$ and $M[[r+1,m],[c-1]]$ are empty and $M[[r,m],[c,n]]$ is a walking matrix (see Figure~\ref{p12}). % need to change the picture somehow
\end{thm}
\begin{figure}[h!]
\centering
