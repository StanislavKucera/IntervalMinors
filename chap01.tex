...
\subsection{Empty rows and columns}
\begin{obs}
...
Open question:
\begin{itemize}
\item 2 rows, 1 interval of one-entries, 3 rows, 2 intervals... and generalization
\item using the previous point to characterize insertion of an empty column to a bigger matrix
